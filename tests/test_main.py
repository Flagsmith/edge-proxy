...
def test_health_check_returns_200_if_cache_was_updated_recently(
    ...
    mocked_environment_service = mocker.patch("edge_proxy.main.environment_service")
...
def test_get_flags(
    ...
    mocked_environment_cache = mocker.patch("edge_proxy.main.environment_service.cache")
